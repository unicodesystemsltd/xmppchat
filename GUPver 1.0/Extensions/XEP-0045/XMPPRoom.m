...
//        [[NSNotificationCenter defaultCenter] postNotificationName:@"configForm" object:nil userInfo:[NSDictionary dictionaryWithObject:x forKey:@"form"]];
	}
}
...
- (void)configureRoomUsingOptions:(NSXMLElement *)roomConfigForm from:(NSString*)jid
{
    dispatch_block_t block = ^{ @autoreleasepool {
